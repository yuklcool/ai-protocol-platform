...
# a deliberately unique placeholder for the MCP Apps sandbox origin, then this
# entrypoint replaces it from runtime env so one GHCR image can be deployed on
# different hosts without rebuilding the frontend.
PLACEHOLDER='__MCP_SANDBOX_PUBLIC_URL__'
